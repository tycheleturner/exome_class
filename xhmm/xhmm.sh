...
#get the list first running: ls ../read_depth/*.DATA.sample_interval_summary > AJ.txt
 
PATHxhmm='/net/eichler/vol4/home/tychele/software/xhmm/statgen-xhmm-3c57d886bc96/build/execs/xhmm'
PATHparam='params.txt'
datasetName="$1"
